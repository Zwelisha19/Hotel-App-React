...
//                 <div>
//                     <p>Map</p>
//                     {/* Change the button text and action to log in */}
                ...
                <div>
                    ...
                    <Link to={"/Login"}>
                        <button 
                            ...
                            onClick={() => setShowLoginMessage(true)} // Show message on click
                        >
                            Login
                        </button>
                    </Link>
...
function Home() {
    ...
    const handleBookNowClick = () => {
        setShowLoginMessage(true); // Show message when "Book Now" button is clicked
    };
    ...
    return (
        <div className="home-container">
            ...
            {/* Display message if showLoginMessage is true */}
            {showLoginMessage && (
                <div className="login-message">
                    <p>Please log in to access your account.</p>
                </div>
